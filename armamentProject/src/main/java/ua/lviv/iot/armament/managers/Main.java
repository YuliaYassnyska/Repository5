...
public static void main(final String[] args) {
        ...
        armament.add(new Armament(ApartmentType.PISTOLS, 1500,
                Power.LOW,
                Use.ATTACK,
                User.CIVIL, 3));

        armament.add(new Armament(ApartmentType.GRENADES, 3000,
                Power.HIGH,
                Use.DEFENSE,
                User.CIVIL, 5));

        armament.add(new Armament(ApartmentType.SNIPERDEVISE, 2500,
                Power.MIDDLE,
                Use.DEFENSE,
                User.COLDIER, 6));

        armament.add(new Armament(ApartmentType.PISTOLS, 2000,
                Power.LOW, Use.ATTACK, 
                User.CIVIL, 9));

        armament.add(new Armament(ApartmentType.SNIPERDEVISE, 4000,
                Power.HIGH,
                Use.DEFENSE,
                User.COLDIER, 1));
